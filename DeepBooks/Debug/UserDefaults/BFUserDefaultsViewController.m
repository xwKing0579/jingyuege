...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"jjAnnihilationSigil"].original style:(UIBarButtonItemStyleDone) target:self action:@selector(removeUserDefaulesData)];
