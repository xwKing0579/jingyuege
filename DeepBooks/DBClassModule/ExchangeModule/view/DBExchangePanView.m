...
#import "DBExchangePanView.h"
#import "DBExchangeCollectionViewCell.h"

static NSString *identifierCollectCell = @"DBExchangeCollectionViewCell";
@interface DBExchangePanView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
@implementation DBExchangePanView
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    DBExchangeCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:identifierCollectCell forIndexPath:indexPath];
    return cell;
}
...
- (DBBaseLabel *)titleTextLabel{
    if (!_titleTextLabel){
        ...
        _titleTextLabel.text = @"开通会员/会员续费";
    }
...
- (UIButton *)orderRecordButton{
    if (!_orderRecordButton){
        ...
        _orderRecordButton.size = CGSizeMake(74, 30);
        _orderRecordButton.titleLabel.font = DBFontExtension.bodyMediumFont;
        [_orderRecordButton setTitle:@"充值记录" forState:UIControlStateNormal];
