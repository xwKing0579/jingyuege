...
@interface DBGenderBooksViewController ()<JXCategoryViewDelegate,JXCategoryListContainerViewDelegate,UIGestureRecognizerDelegate>
...
@implementation DBGenderBooksViewController
...
- (id<JXCategoryListContentViewDelegate>)listContainerView:(JXCategoryListContainerView *)listContainerView initListForIndex:(NSInteger)index {
    DBGenderBooksListViewController *vc = DBGenderBooksListViewController.new;
    vc.index = index;
    return vc;
}
