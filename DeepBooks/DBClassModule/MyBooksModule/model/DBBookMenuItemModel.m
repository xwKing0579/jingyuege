...
+ (NSArray *)dataSourceList{
    NSArray *dateList = @[@{@"isSwitch":@1,@"name":@"置顶书本",@"mid":@0},
                          ...
                          @{@"icon":@"catalog",@"name":@"目录列表",@"mid":@2},
                          @{@"icon":@"comment",@"name":@"查看书评",@"mid":@3},
                          @{@"icon":@"cultivate",@"name":@"养肥本书",@"mid":@4},
                          @{@"icon":@"delete",@"name":@"删除书籍",@"mid":@5},
                          @{@"icon":@"clear",@"name":@"清除缓存",@"mid":@6},
                          @{@"icon":@"share",@"name":@"分享好友",@"mid":@7},
    ];
