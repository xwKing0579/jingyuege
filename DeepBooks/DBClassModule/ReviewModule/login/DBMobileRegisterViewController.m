...
@implementation DBMobileRegisterViewController
...
- (UIButton *)registerButton{
    if (!_registerButton){
        ...
        _registerButton.backgroundColor = DBColorExtension.azureColor;
