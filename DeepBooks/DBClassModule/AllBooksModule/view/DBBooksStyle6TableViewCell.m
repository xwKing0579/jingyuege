//
//  DBBooksStyle6TableViewCell.m
//  DeepBooks
//
//  Created by 王祥伟 on 2025/3/21.
//

#import "DBBooksStyle6TableViewCell.h"
#import "DBAllBooksItemView.h"

@interface DBBooksStyle6TableViewCell ()
...
@implementation DBBooksStyle6TableViewCell
...
- (void)setUpSubViews{
    ...
    CGFloat space = 12;
    CGFloat width = (UIScreen.screenWidth-48)/3;
    CGFloat height = width*5.0/4.0+84;
    CGFloat top = 50;
    
    for (NSInteger index = 0; index < 6; index++) {
        CGFloat left = (width + space) * (index % 3) + space;
