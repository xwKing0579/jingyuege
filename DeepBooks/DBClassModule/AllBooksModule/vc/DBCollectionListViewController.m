//
//  DBCollectionListViewController.m
//  DeepBooks
//
//  Created by 王祥伟 on 2025/8/4.
//

#import "DBCollectionListViewController.h"
#import "DBCollectionIndexViewController.h"

@interface DBCollectionListViewController ()<JXCategoryViewDelegate,JXCategoryListContainerViewDelegate,UIGestureRecognizerDelegate>
...
@implementation DBCollectionListViewController
...
- (id<JXCategoryListContentViewDelegate>)listContainerView:(JXCategoryListContainerView *)listContainerView initListForIndex:(NSInteger)index {
    DBCollectionIndexViewController *vc = DBCollectionIndexViewController.new;
    vc.index = index;
    return vc;
}
