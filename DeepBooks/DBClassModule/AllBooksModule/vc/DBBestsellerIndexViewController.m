//
//  DBBestsellerIndexViewController.m
//  DeepBooks
//
...
@interface DBBestsellerIndexViewController ()<DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>

@end

@implementation DBBestsellerIndexViewController
