//
//  DBHottestListViewController.m
//  DeepBooks
//
//  Created by 王祥伟 on 2025/7/13.
//

#import "DBHottestListViewController.h"
#import "DBHottestIndexViewController.h"

@interface DBHottestListViewController ()<JXCategoryViewDelegate,JXCategoryListContainerViewDelegate,UIGestureRecognizerDelegate>
...
@implementation DBHottestListViewController
...
- (id<JXCategoryListContentViewDelegate>)listContainerView:(JXCategoryListContainerView *)listContainerView initListForIndex:(NSInteger)index {
    DBHottestIndexViewController *vc = DBHottestIndexViewController.new;
    vc.index = index;
    return vc;
}
