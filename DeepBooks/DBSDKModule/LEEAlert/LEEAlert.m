...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _modelShadowColor = [DBColorExtension blackColor]; //默认阴影颜色
        if (@available(iOS 13.0, *)) {
            _modelHeaderColor = [UIColor tertiarySystemBackgroundColor]; //默认颜色
            
        } else {
            _modelHeaderColor = [DBColorExtension whiteColor]; //默认颜色
        }
        _modelBackgroundColor = [DBColorExtension blackColor]; //默认背景半透明颜色
...
- (UIView *)container{
    ...
    if (!_container) {
        ...
        _container.backgroundColor = DBColorExtension.noColor;
        ...
        switch (item.type) {
            ...
            case LEEItemTypeTitle:
            {
                ...
                if (@available(iOS 13.0, *)) {
                    ...
                    label.textColor = [DBColorExtension blackColor];
                }
